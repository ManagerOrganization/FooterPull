...
-(void)viewDidLoad {
    ...
    self.fetcher = [[RRNFetchManager alloc] initWithBatchCount:15
                                                withTotalPages:5];
    ...
    RRNFooterViewBugs <RRNInfiniteScrollFooterViewProtocol> *view = [[RRNFooterViewBugs alloc] initWithFrame:(CGRect){0, 0, width , 60.0f}];
