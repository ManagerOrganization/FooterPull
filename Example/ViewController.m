...
@property (strong, nonatomic) RRNFetchManager *fetcher;
@end
...
-(void)viewDidLoad {
    ...
    self.fetcher = [[RRNFetchManager alloc] initWithBatchCount:20 withTotalPages:3];
    ...
    [self.tableView rrn_infinitScrollWithFooter:[self footerViewWithFrame:frame]
                               withTriggerBlock:^{
                                   ...
                                   [strongSelf.fetcher fetchNextPageWithFetchDuration:2
...
-(void(^)(BOOL moreDataFound))fetchNextPageCompletionHandler {
